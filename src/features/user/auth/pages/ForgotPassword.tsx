// src/features/user/auth/pages/ForgotPassword.tsx
  ...
  return (
    <Box sx={{ minHeight: '80vh', display: 'flex', alignItems: 'center', justifyContent: 'center', bgcolor: theme.palette.background.default, px: 2 }}>
      <Paper elevation={6} sx={{ width: '100%', maxWidth: 420, p: { xs: 4, sm: 5 }, borderRadius: 2, textAlign: 'center' }}>
        <Typography variant="h5" fontWeight={700} gutterBottom sx={{ mb: 1 }}>Forgot Password</Typography>
        ...
        <Typography variant="body2" sx={{ mt: 3, color: theme.palette.text.secondary }}>
          ...
          <Link component={RouterLink} to={PUBLIC_ROUTES.LOGIN} underline="hover" sx={{ fontWeight: 600, color: theme.palette.primary.main }}>
            Back to Sign In
          </Link>
        </Typography>
      </Paper>
