import { Box, Container, Typography, Link, IconButton, useTheme, Grid } from '@mui/material';
      ...
      <Container>
        <Grid container spacing={4}>
          ...
          <Grid
            ...
            sx={{ textAlign: { xs: 'center', sm: 'center', md: 'left' } }}
          >
            <Typography variant="subtitle2" fontWeight={700} gutterBottom textTransform="uppercase">
              Company
            </Typography>
        ...
        >
          ...
          <Box>
            {[FacebookIcon, ChatIcon, TwitterIcon, GitHubIcon, SportsBasketballIcon].map(
              (Icon, idx) => (
                <IconButton key={idx} href="#" color="inherit" size="small" sx={{ mx: 0.5 }}>
                  <Icon />
                </IconButton>
              ),
            )}
